...
INSERT INTO VacancyStatuses (status_id, status_name)
VALUES 
(1, 'активна'),
(2, 'закрыта'), 
(3, 'на паузе');

INSERT INTO ResponseStatuses (status_id, status_name)  
VALUES
(1, 'отправлено'),
(2, 'принято'),
(3, 'отклонено');
...
INSERT INTO Employers (emp_id, emp_company_name, emp_contact_person, emp_contacts, emp_address)
VALUES
...
INSERT INTO Vacancies (vac_id, vac_position, vac_description, vac_requirements, vac_salary, vac_emp_id, vac_cat_id, vac_status_id)
VALUES
(1, 'Frontend-разработчик', 'Разработка пользовательских интерфейсов', 'Опыт работы с React, JavaScript', 120000, 1, 7, 1),
(2, 'Менеджер по продажам', 'Работа с корпоративными клиентами', 'Опыт продаж от 3 лет', 80000, 2, 2, 1),
(3, 'Системный администратор', 'Обслуживание IT-инфраструктуры', 'Знание Linux, Windows Server', 90000, 3, 6, 1);

INSERT INTO Responses (resp_id, resp_vacancy_id, resp_resume_id, resp_date, resp_status_id, resp_staff_id)
VALUES
(1, 1, 1, '2024-01-15', 1, 1),
(2, 2, 2, '2024-01-16', 1, 2),
(3, 3, 3, '2024-01-17', 2, 1);

INSERT INTO Interviews (int_id, int_response_id, int_date_time, int_location, int_result)
VALUES
(1, 3, '2025-10-30 14:00:00', 'Омск, ул. Маркса, 10, офис 305', 'кандидат приглашен на работу');
