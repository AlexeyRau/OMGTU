...
BEGIN
    ...
    ELSIF TG_OP = 'UPDATE' THEN
        INSERT INTO vacancies_audit (operation, audit_timestamp, user_name, vac_id, 
                                   old_position, new_position, old_salary, new_salary)
        VALUES ('U', NOW(), current_user, NEW.vac_id, 
                OLD.vac_position, NEW.vac_position, OLD.vac_salary, NEW.vac_salary);
