...
INSERT INTO Vacancies (vac_id, vac_position, vac_description, vac_requirements, vac_salary, vac_emp_id, vac_cat_id, vac_status_id) VALUES
...
(4, 'Senior Backend-разработчик', 'Разработка серверной части приложений', 'Опыт работы с Python/Django от 5 лет', 180000, 4, 5, 1),
(5, 'Маркетолог', 'Продвижение продуктов компании', 'Опыт в digital-маркетинге', 70000, 5, 3, 2),
(6, 'Менеджер по работе с клиентами', 'Обслуживание существующих клиентов', 'Коммуникабельность, стрессоустойчивость', 75000, 5, 2, 3),
(7, 'Junior QA Engineer', 'Тестирование веб-приложений', 'Базовые знания тестирования', 60000, 1, 5, 1);
